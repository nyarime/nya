...
`,
		...
		"send.auth.enabled": "HTTP Basic auth enabled (-user/-password)",
		...
		"send.cf.trace":        "nya send: cloudflare trace (%s)",
		"send.cf.trace.err":    "nya send: cf-trace: %v",
		"send.pack.reading":    "nya send: reading",
		"send.pack.read_done":  "read",
		"send.pack.read_rate":  "read",
		"send.pack.elapsed":    "elapsed",
		"send.pack.compressing":"nya send: compressing",
		"send.pack.compress":   "per-file",
		"send.pack.finalize":   "solid stream",
		"send.pack.solid_slow_hint": "(high level / solid — may take several minutes on multi-GB inputs)",
		"send.pack.done":       "nya send: packed",
		"get.cf.trace":         "nya get: cloudflare trace (%s)",
		"cf.trace.summary":     "  edge colo=%s  ip=%s  loc=%s",
...
`,
		...
		"send.nya_fmt":      "  压缩包  %s",
		"send.get_fmt":      "  nya get --url %s",
		"send.auth.enabled": "已启用 HTTP Basic 认证（-user/-password）",
		"send.stop":         "Ctrl+C 结束",
		...
		"send.cf.trace":        "nya send: Cloudflare 边缘 trace (%s)",
		"send.cf.trace.err":    "nya send: cf-trace: %v",
		"send.pack.reading":    "nya send: 读取",
		"send.pack.read_done":  "已读",
		"send.pack.read_rate":  "读取",
		"send.pack.elapsed":    "已用",
		"send.pack.compressing":"nya send: 压缩",
		"send.pack.compress":   "单文件",
		"send.pack.finalize":   "solid 流",
		"send.pack.solid_slow_hint": "（高等级 / solid，超大文件可能需数分钟）",
		"send.pack.done":       "nya send: 打包完成",
		"get.cf.trace":         "nya get: Cloudflare 边缘 trace (%s)",
		"cf.trace.summary":     "  边缘 colo=%s  ip=%s  loc=%s",
